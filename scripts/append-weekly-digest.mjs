...
function isRelevantDigestTitle(title) {
  ...
  const strong =
    /中小学|义务教育|基础教育|普通高中|高中|小学|初中|校外培训|双减|教辅|教材|教材教辅|教辅材料评议|评议委员会|评议推荐|评议公告|遴选推荐|遴选结果|推荐目录|公告目录|一科一辅|进校园|凡进必审|送评|征订|选用|封面|出版资质|印制|发行|采购|采购意向|政府采购|招标|中标|成交|预算|图书采购|数字资源|同步练习|考试辅导|暑假作业|学习辅助|招生|高考|中考|智慧教育|数字教育|国家智慧教育平台|青少年|未成年人|课后服务|课堂|课程|暑期|校园餐|校服|教师培养|国门学校|出版|图书|书博|BIBF|数字教材|AI教育|AI教辅|题库|学习机|学练机|智能教辅|纸数融合|教育出版|出版传媒|出版集团|出版社|人教社|人民教育出版社|中国教育出版传媒|新华文轩|北师大出版|东方激光|新华书店|发行集团|政策解读|一图读懂|答记者问|问答|图解/.test(
      text,
    );
  if (!strong) return false;

  const higherOnly = /高校|大学|研究生|职业教育|高职|成人教育|就业|党委书记|校长/.test(text);
  const explicitK12 = /中小学|义务教育|基础教育|普通高中|高中|小学|初中|校外培训|双减|教辅|教材|采购|招标|中标|图书采购|数字资源|高考|中考|国门学校|国家智慧教育平台|青少年|未成年人|课后服务|校园餐|校服|学生读本|统编教材/.test(
    text,
  );
